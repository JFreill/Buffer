...
*  Purpose:This is the main program for Assignment #1, CST8152, Fall 2014
*  Version; 1.14.2
...
* The define does not have any effect in Borland 5.02, C++ Builder or other compiler projects.
*/
...
int main(int argc, char **argv){
	...
	b_setmark(ptr_Buffer, b_getsize(ptr_Buffer) - 1);
